<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/Administrar.Master" AutoEventWireup="true" CodeBehind="Productos.aspx.cs" Inherits="CapaPresentacion.Administrador.Productos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" Height="75px" Width="248px" CssClass="float-right">
        <asp:TableRow ID="TableRow1" runat="server">
            ...
            <asp:TableCell>
                <asp:ImageButton ID="btnListar" runat="server" ToolTip="Mostrar todos los Productos" PostBackUrl="~/Administrador/ProductosTodos.aspx" ImageUrl="~/Images/listar.jpg" Height="50px" Width="50px" />
            </asp:TableCell>
            <asp:TableCell>
    ...
    <asp:Table ID="Table2" runat="server" Visible="false" Width="903px">
        <asp:TableRow>
            ...
            <asp:TableCell HorizontalAlign="Left">
                ...
                <asp:ImageButton ID="btnAddProveedor" runat="server" ImageUrl="~/Images/agregar.png" ToolTip="Agregar nuevo Proveedor" Height="30px" Width="30px" Visible="false" PostBackUrl="~/Administrador/Proveedores.aspx" />
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Right">
        ...
        <asp:TableRow HorizontalAlign="Right">
            ...
            <asp:TableCell HorizontalAlign="Left">
                <asp:RequiredFieldValidator ValidationGroup="Guardar" ID="RequiredFieldValidator4" runat="server" ErrorMessage="No se ingresó el precio del producto" ControlToValidate="txtPrecioProducto" CssClass="field-validation-error"></asp:RequiredFieldValidator><br />
                <asp:TextBox ID="txtPrecioProducto" runat="server" TextMode="Number"></asp:TextBox><asp:RangeValidator ID="RangeValidator1" ValidationGroup="Guardar" runat="server" ErrorMessage="El precio no se encuentra en el rango establecido (mayor a 0)" MinimumValue="0" MaximumValue="1000" ControlToValidate="txtPrecioProducto" CssClass="field-validation-error" Type="Double"></asp:RangeValidator>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow HorizontalAlign="Right">
            <asp:TableCell>
            ...
            <asp:TableCell HorizontalAlign="Left">
                <asp:RequiredFieldValidator ValidationGroup="Guardar" ID="RequiredFieldValidator5" runat="server" ErrorMessage="No se ingresó la cantidad del producto" ControlToValidate="txtCantidadProducto" CssClass="field-validation-error"></asp:RequiredFieldValidator><br />
                <asp:TextBox ID="txtCantidadProducto" runat="server" TextMode="Number"></asp:TextBox><asp:RangeValidator ValidationGroup="Guardar" ID="RangeValidator2" runat="server" ErrorMessage="La cantidad no se encuentra en el rango establecido (mayor a 0)" MinimumValue="0" MaximumValue="1000"  ControlToValidate="txtCantidadProducto" CssClass="field-validation-error" SetFocusOnError="True" Type="Integer"></asp:RangeValidator>
            </asp:TableCell>
        </asp:TableRow>
