<%@ Page Title="" Language="C#" MasterPageFile="~/Vendedor/Vendedor.Master" AutoEventWireup="true" CodeBehind="VentaProductos.aspx.cs" Inherits="CapaPresentacion.Vendedor.VentaProductos" %>
    ...
    <center>
        <asp:Table ID="Table1" runat="server" Width="1084px">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:ImageButton ID="btnCliente" runat="server" ToolTip="Agregar Cliente" ImageUrl="~/Images/agregar.png" Height="40px" Width="40px" PostBackUrl="~/Vendedor/Clientes.aspx"/>
                </asp:TableCell>
                <asp:TableCell>
        ...
        <asp:Table ID="Table2" runat="server" Height="37px" Width="867px">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:ImageButton ID="btnListarProductos" PostBackUrl="~/Administrador/ProductosAll.aspx" runat="server" ToolTip="Listar Productos" ImageUrl="~/Images/mostrar.png" Width="40px" Height="40"/>
                </asp:TableCell>
                <asp:TableCell>
        ...
        <asp:SqlDataSource ID="SqlDataSource0" runat="server" ConnectionString="<%$ ConnectionStrings:GPSConnectionString %>" InsertCommand="INSERT INTO [Ventas] ([IdCliente], [IdEmpleado], [TipoVenta], [Total], [Fecha]) VALUES (@IdCliente, @IdEmpleado, @TipoVenta, @Total, @Fecha)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Ventas]" DeleteCommand="DELETE FROM [Ventas] WHERE [IdVenta] = @original_IdVenta" UpdateCommand="UPDATE [Ventas] SET [IdCliente] = @IdCliente, [IdEmpleado] = @IdEmpleado, [TipoVenta] = @TipoVenta, [Total] = @Total, [Fecha] = @Fecha WHERE [IdVenta] = @original_IdVenta">
            <DeleteParameters>
                <asp:Parameter Name="original_IdVenta" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GPSConnectionString %>" InsertCommand="INSERT INTO [DetalleVenta] ([IdVenta], [IdProducto], [Cantidad]) VALUES (@IdVenta, @IdProducto, @Cantidad)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [DetalleVenta]" DeleteCommand="DELETE FROM [DetalleVenta] WHERE [IdDetalleVenta] = @original_IdDetalleVenta" UpdateCommand="UPDATE [DetalleVenta] SET [IdVenta] = @IdVenta, [IdProducto] = @IdProducto, [Cantidad] = @Cantidad WHERE [IdDetalleVenta] = @original_IdDetalleVenta">
            <DeleteParameters>
                <asp:Parameter Name="original_IdDetalleVenta" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
