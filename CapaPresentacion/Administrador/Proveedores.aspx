<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/Administrar.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="CapaPresentacion.Administrador.Proveedores" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" Height="75px" Width="248px" CssClass="float-right">
        <asp:TableRow ID="TableRow1" runat="server">
            ...
            <asp:TableCell>
                <asp:ImageButton ID="btnListar" runat="server" ToolTip="Mostrar todos los Clientes" PostBackUrl="~/Administrador/ProveedoresTodos.aspx" ImageUrl="~/Images/listar.jpg" Height="50px" Width="50px" />
            </asp:TableCell>
            <asp:TableCell>
...
<asp:ValidationSummary ValidationGroup="INSERT" ID="ValidationSummary1" runat="server" CssClass="field-validation-error"/>
<asp:ValidationSummary ID="ValidationSummary2" runat="server" CssClass="field-validation-error"/>
</asp:Content>
